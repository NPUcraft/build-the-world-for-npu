...
public class Shop extends Block implements IHasModel {
    ...
    public static final AxisAlignedBB RADIATOR_AABB = new AxisAlignedBB(0.0D, -1.0D, 0.0D, 0.875D, 1.0D, 1.0D);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state,
        ...
        playerIn.sendMessage(
                new TextComponentString("Your money has been exhausted! You poor bastard!"));
        return true;
    }
}
