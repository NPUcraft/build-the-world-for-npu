...
public class FExt extends Block implements IHasModel {
    ...
    public static final AxisAlignedBB TESTG_AABB = new AxisAlignedBB(0.0D, -1.0D, 0.0D, 1.0D, 2.0D, 1.0D);
    ...
    public FExt() {
        super(Material.ROCK);
        this.setUnlocalizedName("fext");
        this.setRegistryName("npu:fext");
