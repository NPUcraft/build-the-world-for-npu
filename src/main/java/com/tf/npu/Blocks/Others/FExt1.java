...
public class FExt1 extends Block implements IHasModel{
    ...
    public static final AxisAlignedBB TESTG1_AABB = new AxisAlignedBB(0.0D, -1.0D, 0.0D, 1.0D, -1.0D, 1.0D);
    ...
    public FExt1(){
        super(Material.ROCK);
        this.setUnlocalizedName("fext1");
        this.setRegistryName("npu:fext1");
