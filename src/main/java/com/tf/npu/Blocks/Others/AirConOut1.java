...
public class AirConOut1 extends Block implements IHasModel{
    ...
    public static final AxisAlignedBB AirConOut1_AABB = new AxisAlignedBB(0.0D, -1.0D, 0.0D, 1.0D, 1.5D, 1.0D);

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return AirConOut1_AABB;
    }
    @Override
