...
public class CabinetWorkshop2 extends BlockFourSideFacingTemplate {
    public CabinetWorkshop2() {
        super();
        this.setUnlocalizedName("cabinet_workshop2");
        this.setRegistryName("npu:cabinet_workshop2");
