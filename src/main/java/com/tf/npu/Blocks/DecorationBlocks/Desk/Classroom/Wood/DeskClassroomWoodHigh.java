...
public class DeskClassroomWoodHigh extends Block implements IHasModel {
    ...
    public DeskClassroomWoodHigh() {
        super(Material.PISTON);
        this.setTranslationKey("desk_classroom_wood_high");
        this.setRegistryName("npu:desk_classroom_wood_high");
