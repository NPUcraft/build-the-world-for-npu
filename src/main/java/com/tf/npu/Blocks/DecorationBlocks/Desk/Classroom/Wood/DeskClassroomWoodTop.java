...
public class DeskClassroomWoodTop extends Block implements IHasModel {
    ...
    public DeskClassroomWoodTop() {
        super(Material.PISTON);
        this.setTranslationKey("desk_classroom_wood_top");
        this.setRegistryName("npu:desk_classroom_wood_top");
