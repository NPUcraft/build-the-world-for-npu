...
public class BedBoyLeftTable extends Block implements IHasModel {
    ...
    public BedBoyLeftTable() {
        super(Material.ROCK);
        this.setTranslationKey("bedboy_left_table");
        this.setRegistryName("npu:bedboy_left_table");
