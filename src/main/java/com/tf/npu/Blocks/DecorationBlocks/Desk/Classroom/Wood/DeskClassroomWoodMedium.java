...
public class DeskClassroomWoodMedium extends Block implements IHasModel {
    ...
    public DeskClassroomWoodMedium() {
        super(Material.PISTON);
        this.setTranslationKey("desk_classroom_wood_medium");
        this.setRegistryName("npu:desk_classroom_wood_medium");
