...
public class SignInstitution extends Block implements IHasModel {
    ...
    public SignInstitution() {
        super(Material.ROCK);
        this.setTranslationKey("sign_institution");
        this.setRegistryName("npu:sign_institution");
