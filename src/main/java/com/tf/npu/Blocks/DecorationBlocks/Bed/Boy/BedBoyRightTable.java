...
public class BedBoyRightTable extends Block implements IHasModel {
    ...
    public BedBoyRightTable() {
        super(Material.ROCK);
        this.setTranslationKey("bedboy_right_table");
        this.setRegistryName("npu:bedboy_right_table");
