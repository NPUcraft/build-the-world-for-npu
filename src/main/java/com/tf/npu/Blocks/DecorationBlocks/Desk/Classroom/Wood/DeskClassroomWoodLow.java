...
public class DeskClassroomWoodLow extends Block implements IHasModel {
    ...
    public DeskClassroomWoodLow() {
        super(Material.PISTON);
        this.setTranslationKey("desk_classroom_wood_low");
        this.setRegistryName("npu:desk_classroom_wood_low");
