...
public class SignInstitutionSmall extends Block implements IHasModel {
    ...
    public SignInstitutionSmall() {
        super(Material.ROCK);
        this.setTranslationKey("sign_institution_small");
        this.setRegistryName("npu:sign_institution_small");
