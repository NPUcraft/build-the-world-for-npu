...
public class FWell extends Block implements IHasModel {
    ...
    //*******************碰撞箱，如果是1x1x1就删掉*********************
    public static final AxisAlignedBB FWell_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.0D, 1.0D);
    ...
    public FWell() {
        super(Material.ROCK);
        //*******************改*********************
        this.setUnlocalizedName("fwell");
        //*******************改*********************
        this.setRegistryName("npu:fwell");
        //*******************2.5F是黑曜石硬度*********************
