...
public class FRadiator extends Block implements IHasModel {
    //*******************不用管*********************
    ...
    //*******************碰撞箱，如果是1x1x1就删掉*********************
    public static final AxisAlignedBB FRadiator_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.0D, 1.0D);

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return FRadiator_AABB;
    }
    //*******************碰撞箱，如果是1x1x1就删掉*********************
