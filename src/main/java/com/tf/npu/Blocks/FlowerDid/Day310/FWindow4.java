...
public class FWindow4 extends Block implements IHasModel{
    //*******************不用管*********************
    ...
    //*******************碰撞箱，如果是1x1x1就删掉*********************
    public static final AxisAlignedBB FWindow4_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.0D, 1.0D);

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return FWindow4_AABB;
    }
    //*******************碰撞箱，如果是1x1x1就删掉*********************
