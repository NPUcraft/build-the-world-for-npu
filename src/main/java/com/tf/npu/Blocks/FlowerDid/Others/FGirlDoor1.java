...
public class FGirlDoor1 extends Block implements IHasModel {
    ...
    public static final AxisAlignedBB FGirlDoor1_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 0.1D, 1.0D, 1.0D);

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return FGirlDoor1_AABB;
    }
