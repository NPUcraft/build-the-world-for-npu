...
public class FBrailingr extends Block implements IHasModel {
    ...
    public static final AxisAlignedBB FBrailingr_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D);

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return FBrailingr_AABB;
    }
